...
//
// College of Dance
export const BardDance: SubclassBase = {
    ...
    features: [
        {
            level: 3,
            subclassFeature1: ["Dazzling Footwork",
        ...
        {
            level: 6,
            subclassFeature1: ["Inspiring Movement",
            ...
            subclassFeature2: ["Tandem Footwork",
        ...
        {
            level: 14,
            subclassFeature1: ["Leading Evasion",
...
export const BardCulture: SubclassBase = {
    ...
    features: [
        {
            level: 3,
            subclassFeature1: ["Bonus Proficiencies",
            ...
            subclassFeature2: ["Friendly Motivation",
            ...
            subclassFeature3: ["Far and Wide",
                "Also at 3rd level, when you use your Bardic Inspiration, in addition to the die you may also add half of your Charisma modifier, rounded down (minimum of 1) to the result of their roll.",
            ]
        },
        {
            level: 6,
            subclassFeature1: ["The Dance of Battle",
        ...
        {
            level: 14,
            subclassFeature1: ["History Remembers",
...
export const BardSynesthesia: SubclassBase = {
    ...
    features: [
        {
            level: 3,
            subclassFeature1: ["Frissive Synesthesia",
            ...
            subclassFeature2: ["Mixing the Senses",
        ...
        {
            level: 6,
            subclassFeature1: ["Sympathetic Touch",
        ...
        {
            level: 14,
            subclassFeature1: ["Sensory Lockdown",
